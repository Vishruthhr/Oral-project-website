...
export const CLINICAL_CONSTANTS = {
  ...
  CROWN_CODES: [
    { code: '0', label: 'Sound crown', desc: 'No evidence of treated or untreated clinical caries.', color: '#5C8A57', bg: '#EFEBE1', isDMF: null },
  ...
  ROOT_CODES: [
    { code: '0', label: 'Sound root', desc: 'Exposed root with no evidence of decay or restoration.', color: '#5C8A57' },
